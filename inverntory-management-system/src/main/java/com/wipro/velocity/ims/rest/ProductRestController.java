 ...
 * is used at the class level and allows the class to handle the 
 * requests made by the client.
 * Rest controller generates and manages REST data
 * 
...
private ProductRepository prepo;	
     ...
     */
	/*
	 * @PathVariable annotation indicates that a method parameter that a method parameter should be bound to a URI template variable.
	 */
 ...
 // In Postman--POST- http://localhost:8085/ims/api/products
    /*
     * Postman->plus symbol->POST->url->Body->raw->JSON->enter json object->send
     */
 ...
 // In Postman--PUT- http://localhost:8085/ims/api/products/8
    /*
     * Postman->plus symbol->PUT->url->Body->raw->JSON->enter json object->send
     */
